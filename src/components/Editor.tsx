...
import { Cookie, Download, LayoutGrid, Plus, Upload, Paintbrush, SlidersHorizontal, Settings, Share2 } from "lucide-react";
...
export default function Editor({
  ...
  useEffect(() => {
    setTitle(doc.title);
    const normalized = String(doc.content ?? "").replace(/\r\n/g, "\n");
